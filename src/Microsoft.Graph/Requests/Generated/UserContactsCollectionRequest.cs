...
namespace Microsoft.Graph
{
    ...
    public partial class UserContactsCollectionRequest : BaseRequest, IUserContactsCollectionRequest
    {
        ...
        /// <param name="contact">The Contact to add.</param>
        /// <returns>The created Contact.</returns>
        public RequestBatchPart<Contact> BatchPartAdd(Contact contact)
        {
            ...
            RequestBatchPart<Contact> batchPart = new RequestBatchPart<Contact>(HttpMethod.Post, batchPartUrl, contact);
            return batchPart;
            //return this.AddAsync(contact, CancellationToken.None);
        }
