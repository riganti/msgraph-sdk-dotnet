...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IGovernanceScenarioRoleAssignmentsCollectionRequestBuilder.
    /// </summary>
    public partial interface IGovernanceScenarioRoleAssignmentsCollectionRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IGovernanceScenarioRoleAssignmentsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IGovernanceScenarioRoleAssignmentsCollectionRequest Request(IEnumerable<Option> options);
