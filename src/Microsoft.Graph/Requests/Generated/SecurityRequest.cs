    ...
    public partial class SecurityRequest : BaseRequest, ISecurityRequest
    {
        ...
        private void InitializeCollectionProperties(Security securityToInitialize)
        {
            ...
            if (securityToInitialize != null && securityToInitialize.AdditionalData != null)
            {
                ...
                if (securityToInitialize.ApplicationSecurityProfiles != null && securityToInitialize.ApplicationSecurityProfiles.CurrentPage != null)
                {
                    securityToInitialize.ApplicationSecurityProfiles.AdditionalData = securityToInitialize.AdditionalData;

                    object nextPageLink;
                    securityToInitialize.AdditionalData.TryGetValue("applicationSecurityProfiles@odata.nextLink", out nextPageLink);
                    var nextPageLinkString = nextPageLink as string;

                    if (!string.IsNullOrEmpty(nextPageLinkString))
                    {
                        securityToInitialize.ApplicationSecurityProfiles.InitializeNextPageRequest(
                            this.Client,
                            nextPageLinkString);
                    }
                }
